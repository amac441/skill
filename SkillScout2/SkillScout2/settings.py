...
GEOIP_DATA= (os.path.join(PROJECT_ROOT,'../static/geo/GeoLiteCity.dat'))
GEOIP_SESSION_FIELDS = ['city']
...
ROOT_URLCONF = 'SkillScout2.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'SkillScout2.wsgi.application'
